...
//CODE HERE
let empOne = new Employee(`Captain Hook`, `weekday evenings, weekend mornings`)
console.log(empOne)
...
//CODE HERE
let manager = new Manager("Wendy", ["weekday mornings", "weekday afternoons"], ["Michael", "Tinkerbell"])
