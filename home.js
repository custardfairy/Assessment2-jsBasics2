...
const greetUser = (username) => {
  ...
  greetUser('Space Ghost'); // => 'Welcome back, Space Ghost!'
...
const canWeDeliver = zipCode => {
    if (deliveryAreaZipCodes.includes(zipCode)){
        return "Your order is eligible for delivery!"
    }
    return "We're sorry; you address is not in our delivery area." 
}
...
console.log(canWeDeliverTwo(87195));
...
//CODE HERE
let month = deals[1].desc.replace("March", "April")
let result = deals[1].desc.trim();
console.log(month)