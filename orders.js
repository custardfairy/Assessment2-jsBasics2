...
let firstTicket = new Ticket(["pesto ravioli", "chocolate pie", "lemonade"], "7:55 PM", 49);
...
//CODE HERE
firstTicket.items = "pesto ravioli", "chocolate pie", "lemonade";
firstTicket.orderTime = "7:55 PM";
firstTicket.customerId = 49
